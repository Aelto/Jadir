...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__ws_manager_js__ = __webpack_require__(83);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__api_api_ts__ = __webpack_require__(84);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__views_features_vue__ = __webpack_require__(78);
...
var render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  ...
  }, [_vm._v("Previous page")]) : _vm._e(), _vm._v(" "), _c('div', {
    staticClass: "current-page"
  }, [_vm._v(_vm._s(_vm.$route.params.page))]), _vm._v(" "), (_vm.posts.length >= 20) ? _c('button', {
    staticClass: "next",
    on: {
      "click": _vm.nextPage
    }
...
var render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  ...
  }, [_vm._v("My posts")]), _vm._v(" "), _c('router-link', {
    staticClass: "option",
    attrs: {
      "to": "/features"
    }
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__upvote_control_vue__ = __webpack_require__(89);
//
//
//
//
...
/* harmony default export */ __webpack_exports__["a"] = ({
  ...
  components: {
    ...
    upvoteControl: __WEBPACK_IMPORTED_MODULE_4__upvote_control_vue__["a" /* default */]
  },
  data: () => ({
    comments: [],
    displayEmptyMessage: false,
...
var render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  ...
  }), _vm._v(" "), _c('upvote-control', {
    attrs: {
      "v-if": _vm.account.logged,
      "is-upvote-active": _vm.postVote !== null && _vm.postVote,
      "is-downvote-active": _vm.postVote !== null && !_vm.postVote
    },
    on: {
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__babel_loader_node_modules_vue_loader_lib_selector_type_script_index_0_features_vue__ = __webpack_require__(81);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_692ce9f2_hasScoped_true_node_modules_vue_loader_lib_selector_type_template_index_0_features_vue__ = __webpack_require__(82);
var disposed = false
function injectStyle (ssrContext) {
  if (disposed) return
...
if(content.locals) module.exports = content.locals;
// add the styles to the DOM
var update = __webpack_require__(1)("2ec2f9cb", content, false);
// Hot Module Replacement
if(false) {
 // When the styles change, update the <style> tags
 if(!content.locals) {
...
var render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('div', {
    ...
    directives: [{
      name: "model",
      rawName: "v-model",
      value: (_vm.displayTodo),
      expression: "displayTodo"
    }],
    attrs: {
      "type": "checkbox",
      "name": "todos"
    ...
    domProps: {
      "checked": Array.isArray(_vm.displayTodo) ? _vm._i(_vm.displayTodo, null) > -1 : (_vm.displayTodo)
    },
    on: {
      "__c": function($event) {
        var $$a = _vm.displayTodo,
          $$el = $event.target,
          $$c = $$el.checked ? (true) : (false);
        if (Array.isArray($$a)) {
          var $$v = null,
            $$i = _vm._i($$a, $$v);
          if ($$el.checked) {
            $$i < 0 && (_vm.displayTodo = $$a.concat($$v))
          } else {
            $$i > -1 && (_vm.displayTodo = $$a.slice(0, $$i).concat($$a.slice($$i + 1)))
          }
        } else {
          _vm.displayTodo = $$c
        }
  ...
  }, [_vm._v("todo")]), _vm._v(" "), _c('input', {
    directives: [{
      name: "model",
      rawName: "v-model",
      value: (_vm.displayInprogress),
      expression: "displayInprogress"
    }],
    attrs: {
      "type": "checkbox",
      "name": "inprogress"
    ...
    domProps: {
      "checked": Array.isArray(_vm.displayInprogress) ? _vm._i(_vm.displayInprogress, null) > -1 : (_vm.displayInprogress)
    },
    on: {
      "__c": function($event) {
        var $$a = _vm.displayInprogress,
          $$el = $event.target,
          $$c = $$el.checked ? (true) : (false);
        if (Array.isArray($$a)) {
          var $$v = null,
            $$i = _vm._i($$a, $$v);
          if ($$el.checked) {
            $$i < 0 && (_vm.displayInprogress = $$a.concat($$v))
          } else {
            $$i > -1 && (_vm.displayInprogress = $$a.slice(0, $$i).concat($$a.slice($$i + 1)))
          }
        } else {
          _vm.displayInprogress = $$c
        }
      }
    }
  }), _vm._v(" "), _c('label', {
  ...
  }, [_vm._v("inprogress")]), _vm._v(" "), _c('input', {
    directives: [{
      name: "model",
      rawName: "v-model",
      value: (_vm.displayDone),
      expression: "displayDone"
    }],
    attrs: {
      "type": "checkbox",
      "name": "done"
    ...
    domProps: {
      "checked": Array.isArray(_vm.displayDone) ? _vm._i(_vm.displayDone, null) > -1 : (_vm.displayDone)
    },
    on: {
      "__c": function($event) {
        var $$a = _vm.displayDone,
          $$el = $event.target,
          $$c = $$el.checked ? (true) : (false);
        if (Array.isArray($$a)) {
          var $$v = null,
            $$i = _vm._i($$a, $$v);
          if ($$el.checked) {
            $$i < 0 && (_vm.displayDone = $$a.concat($$v))
          } else {
            $$i > -1 && (_vm.displayDone = $$a.slice(0, $$i).concat($$a.slice($$i + 1)))
          }
        } else {
          _vm.displayDone = $$c
        }
  ...
  }, [_vm._v("done")]), _vm._v(" "), _c('ul', [_vm._l((_vm.features.todo), function(todo, index) {
    return (_vm.displayTodo) ? _c('li', {
      key: index,
      staticClass: "feature todo"
    }, [_vm._v(_vm._s(todo))]) : _vm._e()
  }), _vm._v(" "), _vm._l((_vm.features.inprogress), function(inprogress, index) {
    return (_vm.displayInprogress) ? _c('li', {
      key: index,
      staticClass: "feature inprogress"
    }, [_vm._v(_vm._s(inprogress))]) : _vm._e()
  }), _vm._v(" "), _vm._l((_vm.features.done), function(done, index) {
    return (_vm.displayDone) ? _c('li', {
      key: index,
      staticClass: "feature done"
    }, [_vm._v(_vm._s(done))]) : _vm._e()
  })], 2)])
}
var staticRenderFns = []
render._withStripped = true
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__posts_ts__ = __webpack_require__(85);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__comments_ts__ = __webpack_require__(86);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__account_ts__ = __webpack_require__(87);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__users_ts__ = __webpack_require__(88);
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__babel_loader_node_modules_vue_loader_lib_selector_type_script_index_0_upvote_control_vue__ = __webpack_require__(92);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_d54580ec_hasScoped_true_node_modules_vue_loader_lib_selector_type_template_index_0_upvote_control_vue__ = __webpack_require__(93);
var disposed = false
function injectStyle (ssrContext) {
  if (disposed) return
...
var __vue_styles__ = injectStyle
/* scopeId */
var __vue_scopeId__ = "data-v-d54580ec"
/* moduleIdentifier (server only) */
var __vue_module_identifier__ = null
var Component = normalizeComponent(
  __WEBPACK_IMPORTED_MODULE_0__babel_loader_node_modules_vue_loader_lib_selector_type_script_index_0_upvote_control_vue__["a" /* default */],
  __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_d54580ec_hasScoped_true_node_modules_vue_loader_lib_selector_type_template_index_0_upvote_control_vue__["a" /* default */],
  __vue_styles__,
  __vue_scopeId__,
  __vue_module_identifier__
)
Component.options.__file = "src\\views\\upvote-control.vue"
if (Component.esModule && Object.keys(Component.esModule).some(function (key) {return key !== "default" && key.substr(0, 2) !== "__"})) {console.error("named exports are not supported in *.vue files.")}
if (Component.options.functional) {console.error("[vue-loader] upvote-control.vue: functional components are not supported with templates, they should use render functions.")}
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-d54580ec", Component.options)
  } else {
    hotAPI.reload("data-v-d54580ec", Component.options)
  }
  module.hot.dispose(function (data) {
    disposed = true
  })
...
if(content.locals) module.exports = content.locals;
// add the styles to the DOM
var update = __webpack_require__(1)("fa869a82", content, false);
// Hot Module Replacement
if(false) {
 // When the styles change, update the <style> tags
 if(!content.locals) {
   module.hot.accept("!!../../node_modules/css-loader/index.js!../../node_modules/vue-loader/lib/style-compiler/index.js?{\"vue\":true,\"id\":\"data-v-d54580ec\",\"scoped\":true,\"hasInlineConfig\":false}!../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./upvote-control.vue", function() {
     var newContent = require("!!../../node_modules/css-loader/index.js!../../node_modules/vue-loader/lib/style-compiler/index.js?{\"vue\":true,\"id\":\"data-v-d54580ec\",\"scoped\":true,\"hasInlineConfig\":false}!../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./upvote-control.vue");
     if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
     update(newContent);
   });
 }
...
// module
exports.push([module.i, "\n.upvote-control[data-v-d54580ec] {\r\n  display: flex;\r\n  /* justify-content: space-around; */\r\n  padding: 1em;\n}\n.upvote-control button[data-v-d54580ec] {\r\n  cursor: pointer;\r\n  background: none;\r\n  outline: none;\r\n  border: 0;\r\n  text-decoration: none;\n}\n.upvote-control button[data-v-d54580ec]:hover {\r\n  text-decoration: underline;\n}\n.upvote-control button.active[data-v-d54580ec] {\r\n  font-weight: bold;\n}\r\n", ""]);
...
/* harmony default export */ __webpack_exports__["a"] = ({
  props: ['isUpvoteActive', 'isDownvoteActive'],
  methods: {
    upvote() {
      this.$emit('upvote');
    },
...
var render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('div', {
    staticClass: "upvote-control"
  }, [_c('button', {
    staticClass: "up default link-style",
    class: {
      active: _vm.isUpvoteActive
    },
    on: {
      "click": _vm.upvote
    }
